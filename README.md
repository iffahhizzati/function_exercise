...
4. Write a function to calculate area of the circle where radius is input and formula is A=pi(3.142) * square of radius.
5. Write a function to convert minute into seconds.
6. Write a function to calculate area of the rectangle where width and height of the rectangle are input.
7. Write a function to convert age (in years) to the days. Assume that there are 365 days in 1 year.
8. Write a function to convert hours into minutes.
